...
\begin{document}
    ...
    \input{tex/transformation-zu-html.tex}
    \input{tex/noetige-veraenderungen-an-einer-computerumgebung.tex}
    \input{tex/abschliessende-bemerkungen.tex}
    \input{tex/inhalt-des-abgabeordners.tex}
